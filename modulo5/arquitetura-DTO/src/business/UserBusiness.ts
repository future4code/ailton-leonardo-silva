...
export class UserBusiness {
  public signup = async (input: IUserInputDTO) => {
  ...
  public getUsers = async (input: IUserGetTokenDTO) => {
    ...
    const getUsersInputDB: IUserGetDTO = {
      search,
      order,
      sort,
      limit,
    ...
    const users = usersDB.map((userDB) => {
      ...
      const userResponse: IUserOutputNormalDTO = {
        id: user.getId(),
        name: user.getName(),
        email: user.getEmail(),
      };
  ...
  public deleteUser = async (input: IUserDeleteDTO) => {
    const token = input.token;
  ...
  public editUser = async (input: IUserInputToEditDTO) => {
